...
```{r, echo=FALSE, out.width="100%", out.height= "100%", fig.cap="Kaynak: (Mavimbela ve diğerleri, 2018: 42)"}
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/sekil-1.png")
```
