...
Climate change is a global crisis that affects countries in different ways. The impacts of climate change are already affecting production and development sectors in many countries. Low- and middle-income countries are particularly vulnerable to the effects of climate change due to their limited financial and technical capacities to adopt alternative technologies, monitor population practices, and implement strategies to mitigate the impacts of this crisis. However, many countries continue to lack the necessary policies to support adequate responses to address the problem. [@glasgow2018public]


On December 15, 2018, in the town of Katowice, Poland, a detailed set of rules was adopted to support and implement the Paris Agreement, prepared under the United Nations Framework Convention on Climate Change. This agreement required each country to monitor their emissions and climate policies by following a standardized set of standards. Furthermore, countries were expected to reduce their emissions before the next round of negotiations in 2020. Climate change is a complex issue that cannot be solved solely by national governments. Real actions are required from various sources, including entrepreneurs and the business community, at the city and state levels. [@dhanda2019climate]

Climate change policies have long been subject to the influence of various organizations. However, the crucial role of public relations activities in the field of climate policies has been overlooked for a long time. Public relations practices play a significant role in climate policy. These activities range from short-term advertising campaigns to long-term social responsibility campaigns. [@brulle2021role] Therefore, the first section of the research is dedicated to the public relations literature to assess the communication activities of climate change and its actors in the context of public relations.
...
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/sekil-1.2.png")
```
