...
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/sekil-4-1.png")
```
...
```{r, echo=FALSE, out.width="95%", out.height= "95%", fig.cap="Kaynak: (Grimmer ve Stewart, 2013: 268)"}
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/sekil-4-2.png")
```
...
```{r, echo=FALSE, out.width="95%", out.height= "95%", fig.cap="Kaynak: (Mavimbela ve diğerleri, 2018: 42)"}
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/tablo-4-1.png")
```
...
```{r, echo=FALSE, out.width="95%", out.height= "95%", fig.cap="Kaynak: (Mavimbela ve diğerleri, 2018: 42)"}
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/sekil-4-3.png")
```
 
**Şekil 4.4:** Bakanlıklar Tweet Sayısı 2020-2021.

```{r, echo=FALSE, out.width="95%", out.height= "95%", fig.cap="Kaynak: (Mavimbela ve diğerleri, 2018: 42)"}
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/sekil-4-4.png")
```
 
**Tablo 4.2:** Bakanlıklar ve STK’ların Toplam Tweet Sayısı Betimsel İstatistikleri.

```{r, echo=FALSE, out.width="95%", out.height= "95%", fig.cap="Kaynak: (Mavimbela ve diğerleri, 2018: 42)"}
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/tablo-4-2.png")
```
...
```{r, echo=FALSE, out.width="95%", out.height= "95%", fig.cap="Kaynak: (Mavimbela ve diğerleri, 2018: 42)"}
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/tablo-4-3.png")
```
...
```{r, echo=FALSE, out.width="95%", out.height= "95%", fig.cap="Kaynak: (Mavimbela ve diğerleri, 2018: 42)"}
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/tablo-4-4.png")
```
...
```{r, echo=FALSE, out.width="95%", out.height= "95%", fig.cap="Kaynak: (Mavimbela ve diğerleri, 2018: 42)"}
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/tablo-4-5.png")
```
...
```{r, echo=FALSE, out.width="95%", out.height= "95%", fig.cap="Kaynak: (Mavimbela ve diğerleri, 2018: 42)"}
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/tablo-4-6.png")
```
...
```{r, echo=FALSE, out.width="95%", out.height= "95%", fig.cap="Kaynak: (Mavimbela ve diğerleri, 2018: 42)"}
knitr::include_graphics("/Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/tablo-4-7.png")
```
...
```{r, echo=FALSE, out.width="95%", out.height= "95%", fig.cap="Kaynak: (Mavimbela ve diğerleri, 2018: 42)"}
knitr::include_graphics("//Users/kemalgunay/Desktop/VERI_BILIMI/tez_bookdown2/tablolar-sekiller/tablo-4-8.png")
```
